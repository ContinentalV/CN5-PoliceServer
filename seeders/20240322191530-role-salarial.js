...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert('Roles', [
      ...
      {idRole: '1162834027368165569', name: 'Commandant', salary: 6600000, codeMetier: 'BCSO'},
      {idRole: '1218609551167983636', name: 'Chief-Deputy', salary: 6500000, codeMetier: 'BCSO'},
      {idRole: '1147211942797262938', name: 'Captain', salary: 4300000, codeMetier: 'BCSO'},
      {idRole: '1218299395875803336', name: 'Lieutenant III', salary: 4200000, codeMetier: 'BCSO'},
      {idRole: '1163531941891551362', name: 'Lieutenant II', salary: 4100000, codeMetier: 'BCSO'},
      {idRole: '1147211942780473351', name: 'Lieutenant I', salary: 3900000, codeMetier: 'BCSO'},
      {idRole: '1147211942780473345', name: 'Sergeant III', salary: 3600000, codeMetier: 'BCSO'},
      {idRole: '1218299166589980702', name: 'Sergeant II', salary: 3500000, codeMetier: 'BCSO'},
      {idRole: '1147211942780473344', name: 'Sergeant I', salary: 3400000, codeMetier: 'BCSO'},
